...
const TimeSelector = (props) => {
    ...
    return (
        <div className="reservation__time-selector">
            {
                (isMorning && ( <TimeCapsule chooseTime={props.chooseTime} morning="Timing" slots={props.availableTimeSlots.morning} /> ))

                ||

                (isAfternoon && ( <TimeCapsule chooseTime={props.chooseTime} morning="Timing" slots={props.availableTimeSlots.afternoon}/>))

                ||

                (isEvening && ( <TimeCapsule chooseTime={props.chooseTime} morning="Timing" slots={props.availableTimeSlots.evening}/> ))
