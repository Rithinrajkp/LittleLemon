...
const reviews = [
    {image: images.aa, name: "User 1", reviewText: "Review rext rext lorem ipsudolar"},
    {image: images.ab, name: "User 2", reviewText: "Review rext rext lorem ipsudolar"},
    {image: images.ac, name: "User 3", reviewText: "Review rext rext lorem ipsudolar"},
    {image: images.ad, name: "User 4", reviewText: "Review rext rext lorem ipsudolar"},
]
